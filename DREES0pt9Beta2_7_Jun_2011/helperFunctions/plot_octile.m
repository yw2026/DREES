function [primary_mu_sort] = start_octile_plot(fig_handle,y,mu,ln)
% y: original grade
...
hError1 = errorbar([1:ln],yh,syh,'rx-');%'LineWidth',2.5,'MarkerSize',12);
hold on
hError2 = errorbar([1:ln],xh,sxh,'bo--');%'LineWidth',2.5,'MarkerSize',12);
% set(handles.prediction_axis,'LineWidth',2.5,'MarkerSize',12);
xlabel('Patient Group')
ylabel('Prediction')
legend([hError1(1) hError2(1)], 'Original','Prediction model')
axis([1 ln 0 1])
return