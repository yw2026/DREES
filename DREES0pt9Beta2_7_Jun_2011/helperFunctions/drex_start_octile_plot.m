function [primary_mu_sort, origdatahandle, plothandle] = drex_start_octile_plot(fig_handle,y,mu,ln, origlinestyle, firstlinestyle)
% y: original grade
...
origdatahandle = errorbar([1:ln],yh,syh,origlinestyle);%'LineWidth',2.5,'MarkerSize',12);
hold on
plothandle = errorbar([1:ln],xh,sxh,firstlinestyle);%'LineWidth',2.5,'MarkerSize',12);
