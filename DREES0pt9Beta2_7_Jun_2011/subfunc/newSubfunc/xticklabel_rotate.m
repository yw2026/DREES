function xticklabel_rotate90(hAxis,XTick,varargin)
...
fs = get(hAxis,'fontsize');

% Place the new xTickLabels by creating TEXT objects
hText = text(XTick, y, xTickLabels,'fontsize',fs,'parent',hAxis);

% Rotate the text objects by 90 degrees
set(hText,'Rotation',30,'HorizontalAlignment','right',varargin{:})
