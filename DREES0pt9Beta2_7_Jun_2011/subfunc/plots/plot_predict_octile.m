function [hAxis hError1, hError2, hPlot] = plot_predict_octile(hAxis,y,mu)
%function [hAxis hError1, hError2] = plot_predict_octile(hAxis,y,mu)
...
xlabel(hAxis,'Patient Group')
ylabel(hAxis,'Prediction')
