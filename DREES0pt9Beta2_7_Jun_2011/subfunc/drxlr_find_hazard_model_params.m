function [best_model, xmodel, freqvals, freqindex, addset] = drxlr_find_hazard_model_params(surv_time,x, y, model_order, nboot, variables, test_method,lambda, guiflag, waitbar_handle)
%
